...
from server.database.models.application_link import ApplicationLink
...
__all__ = ("Base", "Users", "Courses", "CoursesForStudents", "Sections", "Topics", "Achievements",
           "AchievementsForStudents", "Notes", "ProfessorsDetails", "ProfessorsApplications", "ApplicationLink")
